...
//     return data.flatMap(mainRow => {
//         const matchedRows = joinData.filter(joinRow => {
//             const mainValue = mainRow[joinCondition.right.split('.')[1]];
//             const joinValue = mainRow[joinCondition.left.split('.')[1]];
//             return mainValue === joinValue;
//         });
...
//             return fields.reduce((acc, field) => {
//                 const [tableName, fieldName] = field.split('.');
//                 acc[field] = mainRow[tableName === table ? fieldName : null];
//                 return acc;
//             }, {});
//         }

//         return matchedRows.map(joinRow => {
//             return fields.reduce((acc, field) => {
//                 const [tableName, fieldName] = field.split('.');
//                 acc[field] = tableName === table ? mainRow[fieldName] : joinRow[fieldName];
//                 return acc;
...
//         const matchedRows = data.filter(mainRow => {
//             const mainValue = mainRow[joinCondition.left.split('.')[1]];
//             const joinValue = mainRow[joinCondition.right.split('.')[1]];
//             return mainValue === joinValue;
//         });
...
//             return fields.reduce((acc, field) => {
//                 const [tableName, fieldName] = field.split('.');
//                 acc[field] = joinRow[tableName === table ? fieldName : null];
//                 return acc;
//             }, {});
//         }

//         return matchedRows.map(mainRow => {
//             return fields.reduce((acc, field) => {
//                 const [tableName, fieldName] = field.split('.');
//                 acc[field] = tableName === table ? mainRow[fieldName] : joinRow[fieldName];
//                 return acc;
